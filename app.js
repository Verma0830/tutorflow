...
function renderReportsSheet() {
    ...
    let headerHTML = `
        <thead>
            <!-- Row 1: Day numbers -->
            <tr>
                <th class="sticky-col" style="min-width: 150px; border-right: 1px solid var(--border-color); border-bottom: none; height: 24px; padding: 0;"></th>
    `;
    ...
    headerHTML += `
            ...
            <!-- Row 2: Column Titles -->
            <tr>
                <th class="sticky-col" style="min-width: 150px; text-align: left; padding: 8px 16px; border-right: 1px solid var(--border-color); border-bottom: 2px solid var(--border-color); font-weight: 800; color: var(--text-main); font-size: 13px;">name</th>
    `;
        ...
        filteredStudents.forEach(student => {
            rowsHTML += `
                <tr class="report-student-row">
                    <td class="sticky-col" style="text-align: left; padding: 12px 16px; font-weight: 600; border-right: 1px solid var(--border-color); border-bottom: 1px solid var(--border-color); text-transform: capitalize;">${student.name}</td>
            `;
